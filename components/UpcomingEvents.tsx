...
const eventDetails: Event = {
  ...
  description:
    'Whether you are seeking spiritual growth, healing, or a deeper connection with God, we are here to walk with you on your journey.',
  date: '20',
  month: 'Sept',
  ...
  return (
    <section className=" py-16  padding-container max-container">
      <div className="text-center">
        <p>Upcoming Events</p>
        <h2 className="lg:text-5xl text-3xl font-bold mb-8 uppercase">
      ...
      <div className="mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-[30%] text-black-50 bg-[#F2EFFE] border border-black-50 p-6 lg:p-12 rounded-lg shadow-lg">
          <div className="mb-4 flex items-end gap-3">
            ...
            <p className=" text-sm text-purple-50 capitalize">
              Our Upcoming Event
            </p>
          </div>
