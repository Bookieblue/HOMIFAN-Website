            ...
            <div className="w-full md:w-1/3 md:pl-4 mt-6 md:mt-0 space-y-4">
              <div className="bg-gray-100 p-4 border rounded-md">
                ...
                <p>
                  ...
                  young people to connect, learn, and grow in their faith for
              ...
              <div className="bg-gray-100 p-4 border rounded-md">
                ...
                <p>
                  ...
                  worship nights, special prayer meetings, and the Oboluwaqa
              ...
              <div className="bg-gray-100 p-4 border rounded-md">
                ...
                <p>
                  ...
                  available on our website and enjoy live streaming from
