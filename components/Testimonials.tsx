  ...
  return (
    <section className="py-12 mb-20  padding-container max-container">
      <div className=" mx-auto text-center">
        ...
        <h2 className="text-3xl font-bold mb-8">Testimonials from Church Members</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((testimonial) => (
            <div key={testimonial.id} className=" bg-[white] border p-6 rounded-lg shadow-md">
              <p className="text-lg font-light text-gray-700 mb-4">"{testimonial.text}"</p>
