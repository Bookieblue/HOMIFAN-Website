...
const MomentsGallery = () => {
  ...
  const galleryItems: GalleryItem[] = [
    ...
    { id: 2, imageUrl: "/gallery (6).jpg", altText: "Moment 2" },
    { id: 3, imageUrl: "/gallery (3).jpg", altText: "Moment 3" },
    { id: 4, imageUrl: "/gallery (4).jpg", altText: "Moment 4" },
    ...
    { id: 8, imageUrl: "/gallery (1).jpg", altText: "Moment 8" },
    { id: 9, imageUrl: "/gallery (3).jpg",altText: "Moment 9" },
    { id: 10, imageUrl: "/gallery (6).jpg", altText: "Moment 10" },
    { id: 11, imageUrl: "/gallery (4).jpg",altText: "Moment 11" },
    { id: 12, imageUrl: "/gallery (3).jpg", altText: "Moment 12" },
  ];
