...
export const founderCardProps = {
  ...
  missionTexts: ['The mission of our church is relocating man from his soul to his spirit.'],
  imageSrc: '/GO.svg', 
};
...
export const historyData = {
  ...
  founding: 'House of Prayer Ministries for All Nations was founded by the Lord Jesus through the hands of His humble servant, Prophet Michael Segun Adewunmi Oluwayomi on 11th August 1989 in Akure, Ondo State.',
  mission: 'House of Prayer Ministries for All Nations is a place of worship where believers can come together to build a strong relationship with the Lord. Through devotion, prayer, and dedication to the Word of God, we strive to bring people closer to Him. We believe that having a relationship with Jesus is the most important thing in life. Our mission is to spread the love of Christ and His message to everyone, no matter where they are in the world. We are dedicated to helping others experience the power of prayer and the Holy Spirit."',
  ministry: 'The church has been in operation for over 33 years, primarily ministering in spiritual warfare and deliverance, while also focusing on teaching the message of salvation as commanded by Jesus in Matthew 28:16–20.',
};

export const leadershipData = {
  leaders: [
    { name: 'Prophet Segun Adewumi', title: 'General Overseer', imageUrl: '/GO.svg' },
    { name: 'Imoh Adewumi', title: 'Mummy GO', imageUrl: '/MummyGO.svg' },
    { name: 'Lawrence Osuntuyi', title: 'Superintendent', imageUrl: '/Superintendent.png' },
    { name: 'Adetiloye Aboluwoye', title: 'Resident Pastor (Akure)', imageUrl: '/ResidentPastor(AK).png' },
    { name: 'Samuel Ashaolu', title: 'Resident Pastor (Lagos)', imageUrl: '/ResidentPastor(LG).avif' },
  ],
};
